...
!(function (t, o) {
  ...
  (t.inherit = function (t, o) {
    ...
    (t.is = function (t, o) {
      return (
        null !== t &&
        ((o instanceof Function && t instanceof o) ||
          !(
            void 0 == t.constructor.__implements ||
            !t.constructor.__implements[o]
          ))
      );
    }),
...
void 0 === Box2D && (Box2D = {}),
  ...
  (function () {
    ...
    function q() {
      q.b2Body.apply(this, arguments),
        this.constructor === q && this.b2Body.apply(this, arguments);
    }
    function O() {
    ...
    function _t() {
      _t.b2ContactSolver.apply(this, arguments),
        this.constructor === _t && this.b2ContactSolver.apply(this, arguments);
    }
    function pt() {
    ...
    function Ut() {
      Ut.b2PulleyJointDef.apply(this, arguments),
        this.constructor === Ut && this.b2PulleyJointDef.apply(this, arguments);
    }
    function qt() {
      qt.b2RevoluteJoint.apply(this, arguments),
        this.constructor === qt && this.b2RevoluteJoint.apply(this, arguments);
    }
    function Ot() {
      Ot.b2RevoluteJointDef.apply(this, arguments),
        this.constructor === Ot &&
    ...
    (Box2D.Collision.IBroadPhase = "Box2D.Collision.IBroadPhase"),
      ...
      (Box2D.Dynamics.Joints.b2RevoluteJoint = qt),
      (Box2D.Dynamics.Joints.b2RevoluteJointDef = Ot),
  ...
  (function () {
    ...
    (l.b2AABB = function () {
      ...
      (h.ClipSegmentToLine = function (t, o, i, e) {
        void 0 === e && (e = 0);
        var n,
          s = 0,
          r = (n = o[0]).v,
        ...
        if (
          ...
          (h.x = r.x + c * (a.x - r.x)),
            ...
            (n = t[s]);
          var _;
          l > 0 ? ((_ = o[0]), (n.id = _.id)) : ((_ = o[1]), (n.id = _.id)),
            ++s;
        }
        return s;
      }),
      (h.EdgeSeparation = function (t, o, i, e, n) {
        ...
        for (
          var h = s.col1.x * r.x + s.col2.x * r.y,
            ...
            p = (s = n.R).col1.x * h + s.col1.y * _,
            y = s.col2.x * h + s.col2.y * _,
            u = 0,
            x = Number.MAX_VALUE,
            f = 0;
          f < m;
      ...
      (h.FindMaxSeparation = function (t, o, i, e, n) {
        ...
        for (
          var _ = m * i.R.col1.x + c * i.R.col1.y,
        ...
        for (;;) {
          if (
            ((y =
              -1 == S ? (C - 1 >= 0 ? C - 1 : a - 1) : C + 1 < a ? C + 1 : 0),
            !((d = h.EdgeSeparation(o, i, y, e, n)) > A))
          )
            break;
          (C = y), (A = d);
        }
      ...
      (h.CollidePolygons = function (t, o, i, n, s) {
        ...
        if (((l = h.s_edgeAO[0]), !(m > a))) {
          ...
          if (((c = h.s_edgeBO[0]), !(_ > a))) {
            ...
            var w = h.s_localTangent;
            w.Set(D.x - S.x, D.y - S.y), w.Normalize();
            var g = h.s_localNormal;
            (g.x = w.y), (g.y = -w.x);
            var M = h.s_planePoint;
            M.Set(0.5 * (S.x + D.x), 0.5 * (S.y + D.y));
            var V = h.s_tangent;
            (f = u.R),
              (V.x = f.col1.x * w.x + f.col2.x * w.y),
              (V.y = f.col1.y * w.x + f.col2.y * w.y);
            var I = h.s_tangent2;
            (I.x = -V.x), (I.y = -V.y);
            var G = h.s_normal;
            (G.x = V.y), (G.y = -V.x);
            var L = h.s_v11,
              J = h.s_v12;
            (L.x = u.position.x + (f.col1.x * S.x + f.col2.x * S.y)),
              (L.y = u.position.y + (f.col1.y * S.x + f.col2.y * S.y)),
              (J.x = u.position.x + (f.col1.x * D.x + f.col2.x * D.y)),
              (J.y = u.position.y + (f.col1.y * D.x + f.col2.y * D.y));
            var F = G.x * L.x + G.y * L.y,
              P = -V.x * L.x - V.y * L.y + a,
              R = V.x * J.x + V.y * J.y + a,
              T = h.s_clipPoints1,
              k = h.s_clipPoints2;
            if (
              !(
                h.ClipSegmentToLine(T, v, I, P) < 2 ||
                h.ClipSegmentToLine(k, T, V, R) < 2
              )
            ) {
              t.m_localPlaneNormal.SetV(g), t.m_localPoint.SetV(M);
              for (var N = 0, z = 0; z < e.b2_maxManifoldPoints; ++z)
                if (((r = k[z]), G.x * r.v.x + G.y * r.v.y - F <= a)) {
                  var E = t.m_points[N];
                  f = x.R;
                  var j = r.v.x - x.position.x,
                    U = r.v.y - x.position.y;
                  (E.m_localPoint.x = j * f.col1.x + U * f.col1.y),
                    (E.m_localPoint.y = j * f.col2.x + U * f.col2.y),
                    E.m_id.Set(r.id),
                    (E.m_id.features.flip = b),
                    ++N;
                }
              t.m_pointCount = N;
            }
      ...
      (h.CollideCircles = function (t, o, i, e, n) {
        ...
        (s = n.R), (r = e.m_p);
        var m = n.position.x + (s.col1.x * r.x + s.col2.x * r.y) - a,
          c = n.position.y + (s.col1.y * r.x + s.col2.y * r.y) - l,
          h = m * m + c * c,
          _ = o.m_radius + e.m_radius;
        h > _ * _ ||
      ...
      (h.CollidePolygonAndCircle = function (t, o, i, e, n) {
        ...
        var m = n.position.x + (r.col1.x * s.x + r.col2.x * s.y),
          c = n.position.y + (r.col1.y * s.x + r.col2.y * s.y);
        (a = m - i.position.x), (l = c - i.position.y);
        for (
          var h = a * (r = i.R).col1.x + l * r.col1.y,
            _ = a * r.col2.x + l * r.col2.y,
            p = 0,
            y = -Number.MAX_VALUE,
        ...
        var w = (h - A.x) * (S.x - A.x) + (_ - A.y) * (S.y - A.y),
          g = (h - S.x) * (A.x - S.x) + (_ - S.y) * (A.y - S.y);
        if (w <= 0) {
          if ((h - A.x) * (h - A.x) + (_ - A.y) * (_ - A.y) > u * u) return;
          (t.m_pointCount = 1),
            (t.m_type = B.e_faceA),
            (t.m_localPlaneNormal.x = h - A.x),
            (t.m_localPlaneNormal.y = _ - A.y),
            t.m_localPlaneNormal.Normalize(),
            t.m_localPoint.SetV(A),
            t.m_points[0].m_localPoint.SetV(e.m_p),
            (t.m_points[0].m_id.key = 0);
        } else if (g <= 0) {
          if ((h - S.x) * (h - S.x) + (_ - S.y) * (_ - S.y) > u * u) return;
          (t.m_pointCount = 1),
            (t.m_type = B.e_faceA),
            (t.m_localPlaneNormal.x = h - S.x),
            (t.m_localPlaneNormal.y = _ - S.y),
            t.m_localPlaneNormal.Normalize(),
      ...
      (y.Distance = function (t, o, i) {
        ...
        for (
          var h,
            ...
            u = y.s_saveB,
            x = 0,
            f = (c.GetClosestPoint().LengthSquared(), 0),
            d = 0;
          d < 20;

        ) {
          for (x = c.m_count, f = 0; f < x; f++)
            (p[f] = _[f].indexA), (u[f] = _[f].indexB);
          switch (c.m_count) {
            case 1:
              break;
            case 2:
          ...
          var v = _[c.m_count];
          (v.indexA = s.GetSupport(n.MulTMV(l.R, b.GetNegative()))),
            (v.wA = n.MulX(l, s.GetVertex(v.indexA))),
            (v.indexB = r.GetSupport(n.MulTMV(m.R, b))),
            (v.wB = n.MulX(m, r.GetVertex(v.indexB))),
            (v.w = n.SubtractVV(v.wB, v.wA)),
            ++d,
            ++y.b2_gjkIters;
          var D = !1;
          for (f = 0; f < x; f++)
            if (v.indexA == p[f] && v.indexB == u[f]) {
              D = !0;
              break;
            }
          if (D) break;
        ...
        if (
          ((y.b2_gjkMaxIters = n.Max(y.b2_gjkMaxIters, d)),
          ...
          var B = s.m_radius,
            C = r.m_radius;
          if (t.distance > B + C && t.distance > Number.MIN_VALUE) {
            t.distance -= B + C;
            var A = n.SubtractVV(t.pointB, t.pointA);
            A.Normalize(),
              (t.pointA.x += B * A.x),
              (t.pointA.y += B * A.y),
              (t.pointB.x -= C * A.x),
            ...
            ((h = new a()).x = 0.5 * (t.pointA.x + t.pointB.x)),
              (h.y = 0.5 * (t.pointA.y + t.pointB.y)),
      ...
      (d.prototype.InsertLeaf = function (t) {
        ...
        if (0 == i.IsLeaf())
          do {
            var e = i.child1,
              n = i.child2;
            i =
              Math.abs((e.aabb.lowerBound.x + e.aabb.upperBound.x) / 2 - o.x) +
                Math.abs(
                  (e.aabb.lowerBound.y + e.aabb.upperBound.y) / 2 - o.y
                ) <
              Math.abs((n.aabb.lowerBound.x + n.aabb.upperBound.x) / 2 - o.x) +
        ...
        if (
          ((r.parent = s),
          (r.userData = null),
          r.aabb.Combine(t.aabb, i.aabb),
          s)
        ) {
          i.parent.child1 == i ? (s.child1 = r) : (s.child2 = r),
            (r.child1 = i),
            (r.child2 = t),
            (i.parent = r),
            (t.parent = r);
          do {
            if (s.aabb.Contains(r.aabb)) break;
            s.aabb.Combine(s.child1.aabb, s.child2.aabb),
              (r = s),
              (s = s.parent);
          } while (s);
        } else
      ...
      (b.prototype.UpdatePairs = function (t) {
        ...
        for (e = 0; e < o.m_moveBuffer.length; ++e) {
          ...
          o.m_tree.Query(function (t) {
            ...
            o.m_pairCount == o.m_pairBuffer.length &&
              (o.m_pairBuffer[o.m_pairCount] = new D());
        ...
        for (e = 0; e < o.m_pairCount; ) {
          var s = o.m_pairBuffer[e];
          for (
            t(o.m_tree.GetUserData(s.proxyA), o.m_tree.GetUserData(s.proxyB)),
              ++e;
            e < o.m_pairCount;

          ) {
            var r = o.m_pairBuffer[e];
            if (r.proxyA != s.proxyA || r.proxyB != s.proxyB) break;
            ++e;
          }
        }
      }),
        ...
        if (h > c) {
          ...
          if (0 <= y && y <= e * h) {
            ...
            if (-c * h <= u && u <= h * (1 + c)) {
              ...
              return (l /= x), (m /= x), (t[0] = y), o.Set(l, m), !0;
            }
          }
        }
        return !1;
      ...
      (M.prototype.Initialize = function (t, o, i, s, r) {
        ...
        if (1 == l)
          ...
          (this.m_type = M.e_faceA),
            ...
            (_ = this.m_proxyB.GetVertex(t.indexB[0])),
            (this.m_localPoint.x = 0.5 * (c.x + h.x)),
            (this.m_localPoint.y = 0.5 * (c.y + h.y)),
            (this.m_axis = n.CrossVF(n.SubtractVV(h, c), 1)),
            this.m_axis.Normalize(),
            (x = this.m_axis),
            (D = (u = i.R).col1.x * x.x + u.col2.x * x.y),
            ...
            (u = r.R),
            (C =
              ((b = r.position.x + (u.col1.x * x.x + u.col2.x * x.y)) - f) * D +
              ((v = r.position.y + (u.col1.y * x.x + u.col2.y * x.y)) - d) *
          ...
          (this.m_type = M.e_faceB),
            ...
            this.m_axis.Normalize(),
            (x = this.m_axis),
            (D = (u = r.R).col1.x * x.x + u.col2.x * x.y),
            (B = u.col1.y * x.x + u.col2.y * x.y),
            (x = this.m_localPoint),
            (u = r.R),
            (b = r.position.x + (u.col1.x * x.x + u.col2.x * x.y)),
            ...
            (u = i.R),
            (C =
              ((f = i.position.x + (u.col1.x * x.x + u.col2.x * x.y)) - b) * D +
              ((d = i.position.y + (u.col1.y * x.x + u.col2.y * x.y)) - v) *
                B) < 0 && this.m_axis.NegativeSelf();
        else {
          (c = this.m_proxyA.GetVertex(t.indexA[0])),
            (h = this.m_proxyA.GetVertex(t.indexA[1])),
            ...
            (y = this.m_proxyB.GetVertex(t.indexB[1]));
          n.MulX(i, m);
          var A = n.MulMV(i.R, n.SubtractVV(h, c)),
            S = (n.MulX(r, _), n.MulMV(r.R, n.SubtractVV(y, p))),
            w = A.x * A.x + A.y * A.y,
            g = S.x * S.x + S.y * S.y,
            V = n.SubtractVV(S, A),
            I = A.x * V.x + A.y * V.y,
            ...
            L = A.x * S.x + A.y * S.y,
            J = w * g - L * L;
          (C = 0), 0 != J && (C = n.Clamp((L * G - I * g) / J, 0, 1));
          var F = (L * C + G) / g;
          F < 0 && ((F = 0), (C = n.Clamp((L - I) / w, 0, 1))),
            ((m = new a()).x = c.x + C * (h.x - c.x)),
            (m.y = c.y + C * (h.y - c.y)),
            ((_ = new a()).x = p.x + C * (y.x - p.x)),
            (_.y = p.y + C * (y.y - p.y)),
            0 == C || 1 == C
              ? ((this.m_type = M.e_faceB),
                (this.m_axis = n.CrossVF(n.SubtractVV(y, p), 1)),
                ...
                (x = m),
                (u = i.R),
                ((f = i.position.x + (u.col1.x * x.x + u.col2.x * x.y)) - b) *
                  D +
                  ((d = i.position.y + (u.col1.y * x.x + u.col2.y * x.y)) - v) *
                    B,
              ...
              : ((this.m_type = M.e_faceA),
                ...
                (x = _),
                (u = r.R),
                ((b = r.position.x + (u.col1.x * x.x + u.col2.x * x.y)) - f) *
                  D +
                  ((v = r.position.y + (u.col1.y * x.x + u.col2.y * x.y)) - d) *
                    B,
                C < 0 && this.m_axis.NegativeSelf());
        ...
        switch (this.m_type) {
          case M.e_points:
            return (
              ...
              (l = n.MulX(t, r)),
              (m = n.MulX(o, a)),
              (m.x - l.x) * this.m_axis.x + (m.y - l.y) * this.m_axis.y
            );
          case M.e_faceA:
            return (
      ...
      (V.prototype.ReadCache = function (t, o, i, s, r) {
        ...
        if (this.m_count > 1) {
          var _ = t.metric,
            p = this.GetMetric();
          (p < 0.5 * _ || 2 * _ < p || p < Number.MIN_VALUE) &&
            (this.m_count = 0);
        }
        0 == this.m_count &&
          (((h = m[0]).indexA = 0),
      ...
      (V.prototype.GetSearchDirection = function () {
        switch (this.m_count) {
          ...
          case 2:
            ...
            return n.CrossVV(t, this.m_v1.w.GetNegative()) > 0
              ? n.CrossFV(1, t)
              : n.CrossVF(t, 1);
          default:
      ...
      (L.TimeOfImpact = function (t) {
        ...
        for (L.s_cache.count = 0, L.s_distanceInput.useRadii = !1; ; ) {
          ...
          if (
            (0 == c &&
              (h = _ > a ? n.Max(a - l, 0.75 * a) : n.Max(_ - l, 0.02 * a)),
            _ - h < 0.5 * l)
          ) {
            if (0 == c) {
              m = 1;
          ...
          var p = m,
            ...
            x = 1,
            f = _;
          s.GetTransform(L.s_xfA, x), r.GetTransform(L.s_xfB, x);
          ...
          for (var b = 0; ; ) {
            var v = 0;
            (v = 1 & b ? u + ((h - f) * (x - u)) / (d - f) : 0.5 * (u + x)),
              s.GetTransform(L.s_xfA, v),
              r.GetTransform(L.s_xfB, v);
            var D = L.s_fcn.Evaluate(L.s_xfA, L.s_xfB);
            if (n.Abs(D - h) < 0.025 * l) {
              p = v;
              break;
            }
            if (
          ...
          if (
            ((L.b2_toiMaxRootIters = n.Max(L.b2_toiMaxRootIters, b)),
            p < (1 + 100 * Number.MIN_VALUE) * m)
          )
            break;
          if (((m = p), c++, ++L.b2_toiIters, 1e3 == c)) break;
        }
        return (L.b2_toiMaxIters = n.Max(L.b2_toiMaxIters, c)), m;
      }),
      Box2D.postDefs.push(function () {
            ...
            case B.e_faceA:
              for (
                ...
                (r = e.R),
                  ...
                  (_ = e.position.x + r.col1.x * s.x + r.col2.x * s.y),
                  (p = e.position.y + r.col1.y * s.x + r.col2.y * s.y),
                  (this.m_points[a].x =
                    _ + 0.5 * (i - (_ - c) * l - (p - h) * m - n) * l),
                  (this.m_points[a].y =
                    p + 0.5 * (i - (_ - c) * l - (p - h) * m - n) * m);
              break;
            case B.e_faceB:
              for (
                r = e.R,
                ...
                (r = o.R),
                  (s = t.m_points[a].m_localPoint),
                  (_ = o.position.x + r.col1.x * s.x + r.col2.x * s.y),
                  (p = o.position.y + r.col1.y * s.x + r.col2.y * s.y),
                  (this.m_points[a].x =
                    _ + 0.5 * (n - (_ - c) * l - (p - h) * m - i) * l),
                  (this.m_points[a].y =
                    p + 0.5 * (n - (_ - c) * l - (p - h) * m - i) * m);
          }
        }
      }),
    ...
    Box2D.inherit(o, Box2D.Collision.Shapes.b2Shape),
      ...
      (s.prototype.TestPoint = function (t, o) {
        for (
          ...
          if (
            ((n = r - (i = this.m_vertices[l]).x),
            (s = a - i.y),
            (i = this.m_normals[l]).x * n + i.y * s > 0)
          )
            return !1;
        return !0;
      }),
      (s.prototype.RayCast = function (t, o, i) {
        var e,
          ...
          a = 0,
          l = 0;
        (a = o.p1.x - i.position.x), (l = o.p1.y - i.position.y);
        var m = a * (e = i.R).col1.x + l * e.col1.y,
          c = a * e.col2.x + l * e.col2.y;
        (a = o.p2.x - i.position.x), (l = o.p2.y - i.position.y);
        for (
          var h = a * (e = i.R).col1.x + l * e.col1.y - m,
            _ = a * e.col2.x + l * e.col2.y - c,
            p = parseInt(-1),
            y = 0;
          y < this.m_vertexCount;
          ++y
        ) {
          (a = (n = this.m_vertices[y]).x - m), (l = n.y - c);
          var u = (n = this.m_normals[y]).x * a + n.y * l,
            x = n.x * h + n.y * _;
          if (0 == x) {
            if (u < 0) return !1;
          } else
      ...
      (s.prototype.ComputeMass = function (t, o) {
        ...
        for (
          ...
          s +=
            p *
            ((1 / 3) * (0.25 * (u * u + f * u + f * f) + (0 * u + 0 * f)) +
              0 +
              ((1 / 3) * (0.25 * (x * x + d * x + d * d) + (0 * x + 0 * d)) +
                0));
        }
        (t.mass = o * n),
          (i *= 1 / n),
      ...
      (s.prototype.ComputeSubmergedArea = function (t, o, i, e) {
        ...
        var f,
          d = parseInt((h + 1) % this.m_vertexCount),
          b = parseInt((_ + 1) % this.m_vertexCount),
          v = (0 - a[h]) / (a[d] - a[h]),
          D = (0 - a[_]) / (a[b] - a[_]),
          B = new c(
            this.m_vertices[h].x * (1 - v) + this.m_vertices[d].x * v,
            this.m_vertices[h].y * (1 - v) + this.m_vertices[d].y * v
          ),
          C = new c(
            this.m_vertices[_].x * (1 - D) + this.m_vertices[b].x * D,
            this.m_vertices[_].y * (1 - D) + this.m_vertices[b].y * D
          ),
          A = 0,
          S = new c(),
          w = this.m_vertices[d];
        for (y = d; y != b; ) {
          f = (y = (y + 1) % this.m_vertexCount) == b ? C : this.m_vertices[y];
    ...
    (t.b2Mat22 = function () {
      ...
      (o.prototype.Solve33 = function (t, o, i, e) {
        ...
        return (
          ...
          (t.x =
            p *
            (o * (l * _ - m * h) + i * (m * c - a * _) + e * (a * h - l * c))),
          (t.y =
            p *
            (n * (i * _ - e * h) + s * (e * c - o * _) + r * (o * h - i * c))),
          (t.z =
            p *
    ...
    (x.b2Body = function () {
      ...
      (d.prototype.ShouldCollide = function (t, o) {
        var i = t.GetFilterData(),
          e = o.GetFilterData();
        return i.groupIndex == e.groupIndex && 0 != i.groupIndex
          ? i.groupIndex > 0
      ...
      (D.prototype.Collide = function () {
        for (var t = this.m_world.m_contactList; t; ) {
          ...
          if (0 != e.IsAwake() || 0 != n.IsAwake()) {
            ...
            var r = o.m_proxy,
              a = i.m_proxy;
            0 != this.m_broadPhase.TestOverlap(r, a)
      ...
      (g.prototype.Solve = function (o, i, e) {
        ...
        for (a = 0; a < this.m_bodyCount; ++a)
          (n = this.m_bodies[a]).GetType() == x.b2_dynamicBody &&
            ((n.m_linearVelocity.x += o.dt * (i.x + n.m_invMass * n.m_force.x)),
            (n.m_linearVelocity.y += o.dt * (i.y + n.m_invMass * n.m_force.y)),
        ...
        for (m.InitVelocityConstraints(o), a = 0; a < this.m_jointCount; ++a)
          (r = this.m_joints[a]).InitVelocityConstraints(o);
        for (a = 0; a < o.velocityIterations; ++a) {
          for (l = 0; l < this.m_jointCount; ++l)
            (r = this.m_joints[l]).SolveVelocityConstraints(o);
          m.SolveVelocityConstraints();
        }
        for (a = 0; a < this.m_jointCount; ++a)
          (r = this.m_joints[a]).FinalizeVelocityConstraints();
        for (m.FinalizeVelocityConstraints(), a = 0; a < this.m_bodyCount; ++a)
          if ((n = this.m_bodies[a]).GetType() != x.b2_staticBody) {
            var c = o.dt * n.m_linearVelocity.x,
              h = o.dt * n.m_linearVelocity.y;
            c * c + h * h > s.b2_maxTranslationSquared &&
        ...
        for (a = 0; a < o.positionIterations; ++a) {
          var p = m.SolvePositionConstraints(s.b2_contactBaumgarte),
            y = !0;
          for (l = 0; l < this.m_jointCount; ++l) {
            var u = (r = this.m_joints[l]).SolvePositionConstraints(
        ...
        if ((this.Report(m.m_constraints), e)) {
          ...
          for (a = 0; a < this.m_bodyCount; ++a)
            (n = this.m_bodies[a]).GetType() != x.b2_staticBody &&
              (0 == (n.m_flags & x.e_allowSleepFlag) &&
                ((n.m_sleepTime = 0), (f = 0)),
              0 == (n.m_flags & x.e_allowSleepFlag) ||
              n.m_angularVelocity * n.m_angularVelocity > b ||
              t.Dot(n.m_linearVelocity, n.m_linearVelocity) > d
                ? ((n.m_sleepTime = 0), (f = 0))
                : ((n.m_sleepTime += o.dt), (f = t.Min(f, n.m_sleepTime))));
          if (f >= s.b2_timeToSleep)
            for (a = 0; a < this.m_bodyCount; ++a)
              (n = this.m_bodies[a]).SetAwake(!1);
        }
      }),
      (g.prototype.SolveTOI = function (t) {
        ...
        for (o = 0; o < t.positionIterations; ++o) {
          var m = e.SolvePositionConstraints(0.75),
            c = !0;
          ...
          if (m & B.e_shapeBit)
            for (t = this.m_bodyList; t; t = t.m_next)
              for (l = t.m_xf, o = t.GetFixtureList(); o; o = o.m_next)
                (i = o.GetShape()),
                  0 == t.IsActive()
                    ? (h.Set(0.5, 0.5, 0.3), this.DrawShape(i, l, h))
                    : t.GetType() == x.b2_staticBody
                    ? (h.Set(0.5, 0.9, 0.5), this.DrawShape(i, l, h))
                    : t.GetType() == x.b2_kinematicBody
                    ? (h.Set(0.5, 0.5, 0.9), this.DrawShape(i, l, h))
                    : 0 == t.IsAwake()
                    ? (h.Set(0.6, 0.6, 0.6), this.DrawShape(i, l, h))
                    : (h.Set(0.9, 0.7, 0.7), this.DrawShape(i, l, h));
          if (m & B.e_jointBit)
      ...
      (V.prototype.QueryAABB = function (t, o) {
        ...
        i.Query(function (o) {
          return t(i.GetUserData(o));
        }, o);
      }),
      (V.prototype.QueryShape = function (t, o, e) {
        var n = this;
        void 0 === e && (e = null), null == e && (e = new i()).SetIdentity();
        var s = n.m_contactManager.m_broadPhase,
          a = new r();
        o.ComputeAABB(a, e),
          s.Query(function (i) {
            var n = s.GetUserData(i) instanceof S ? s.GetUserData(i) : null;
            return (
      ...
      (V.prototype.QueryPoint = function (t, o) {
        var i = this.m_contactManager.m_broadPhase,
          e = new r();
        e.lowerBound.Set(o.x - s.b2_linearSlop, o.y - s.b2_linearSlop),
          e.upperBound.Set(o.x + s.b2_linearSlop, o.y + s.b2_linearSlop),
          i.Query(function (e) {
            var n = i.GetUserData(e) instanceof S ? i.GetUserData(e) : null;
            return !n.TestPoint(o) || t(n);
          }, e);
      }),
      ...
      (V.prototype.RayCastAll = function (t, o) {
        ...
        return (
          i.RayCast(
            function (t, o, i, n) {
              return void 0 === n && (n = 0), (e[e.length] = t), 1;
            },
            t,
            o
          ),
      ...
      (V.prototype.Solve = function (t) {
        ...
        for (var r = this.s_stack, a = this.m_bodyList; a; a = a.m_next)
          if (
                ...
                for (var m, c = o.m_contactList; c; c = c.next)
                  c.contact.m_flags & I.e_islandFlag ||
                    (1 != c.contact.IsSensor() &&
                      ...
                      (c.contact.m_flags |= I.e_islandFlag),
                      (m = c.other).m_flags & x.e_islandFlag ||
                        ((r[l++] = m), (m.m_flags |= x.e_islandFlag))));
                for (var h = o.m_jointList; h; h = h.next)
                  1 != h.joint.m_islandFlag &&
                    0 != (m = h.other).IsActive() &&
                    (e.AddJoint(h.joint),
            ...
            for (var _ = 0; _ < e.m_bodyCount; ++_)
              (o = e.m_bodies[_]).GetType() == x.b2_staticBody &&
                (o.m_flags &= ~x.e_islandFlag);
          }
          ...
          if (
            ...
            if (0 != _.IsTouching()) {
              ...
              for (C = 0; C < m.m_contactCount; ++C)
                (h = m.m_contacts[C]).m_flags &= ~(
                  I.e_toiFlag | I.e_islandFlag
                );
              for (C = 0; C < m.m_jointCount; ++C)
                (l = m.m_joints[C]).m_islandFlag = !1;
              this.m_contactManager.FindNewContacts();
            }
          } else
        ...
        switch (t.m_type) {
          ...
          case J.e_pulleyJoint:
            ...
            this.m_debugDraw.DrawSegment(h, a, m),
              this.m_debugDraw.DrawSegment(_, l, m),
              this.m_debugDraw.DrawSegment(h, _, m);
            break;
          case J.e_mouseJoint:
            this.m_debugDraw.DrawSegment(a, l, m);
            break;
  ...
  (function () {
    ...
    Box2D.inherit(n, Box2D.Dynamics.Contacts.b2Contact),
      ...
      (m.prototype.Create = function (t, o) {
        ...
        return null != r
          ? s.primary
            ? ((i = r(this.m_allocator)).Reset(t, o), i)
            : ((i = r(this.m_allocator)).Reset(o, t), i)
          : null;
      }),
      ...
      (_.prototype.Initialize = function (t, o, i, e) {
        void 0 === i && (i = 0);
        var n;
        ...
        for (s = 0; s < i; ++s) {
          ...
          D.b2Assert(x.m_pointCount > 0),
            _.s_worldManifold.Initialize(x, y.m_xf, h, u.m_xf, p);
          var w = _.s_worldManifold.m_normal.x,
            g = _.s_worldManifold.m_normal.y,
          ...
          for (var V = 0; V < M.pointCount; ++V) {
            ...
            var L = (G.rA.x = _.s_worldManifold.m_points[V].x - y.m_sweep.c.x),
              J = (G.rA.y = _.s_worldManifold.m_points[V].y - y.m_sweep.c.y),
            ...
            var z = g,
              ...
              U = F * E - P * z;
            (j *= j), (U *= U);
            var q = y.m_invMass + u.m_invMass + y.m_invI * j + u.m_invI * U;
            (G.tangentMass = 1 / q), (G.velocityBias = 0);
            var O = B + -S * P - b - -A * J,
              K = C + S * F - v - A * L,
      ...
      (_.prototype.SolveVelocityConstraints = function () {
        for (
          var t,
            ...
            u = 0,
            x = 0;
          x < this.m_constraintCount;
          ++x
        ) {
          var f = this.m_constraints[x],
            d = f.bodyA,
            b = f.bodyB,
            v = d.m_angularVelocity,
            D = b.m_angularVelocity,
            B = d.m_linearVelocity,
            A = b.m_linearVelocity,
            S = d.m_invMass,
            w = d.m_invI,
            g = b.m_invMass,
            M = b.m_invI,
          ...
          for (i = 0; i < f.pointCount; i++)
            (t = f.points[i]),
              (n =
                (A.x - D * t.rB.y - B.x + v * t.rA.y) * G +
                (A.y + D * t.rB.x - B.y - v * t.rA.x) * L),
              (s = t.tangentMass * -n),
              (r = J * t.normalImpulse),
              (l =
                (s =
                  (a = C.Clamp(t.tangentImpulse + s, -r, r)) -
                  t.tangentImpulse) * G),
              (m = s * L),
              (B.x -= S * l),
              (B.y -= S * m),
              (v -= w * (t.rA.x * m - t.rA.y * l)),
              (A.x += g * l),
              (A.y += g * m),
              (D += M * (t.rB.x * m - t.rB.y * l)),
              (t.tangentImpulse = a);
          parseInt(f.pointCount);
          if (1 == f.pointCount)
            (t = f.points[0]),
              (e =
                (A.x + -D * t.rB.y - B.x - -v * t.rA.y) * V +
                (A.y + D * t.rB.x - B.y - v * t.rA.x) * I),
              (s = -t.normalMass * (e - t.velocityBias)),
              (l =
                (s =
                  (a = (a = t.normalImpulse + s) > 0 ? a : 0) -
                  t.normalImpulse) * V),
              (m = s * I),
              (B.x -= S * l),
              (B.y -= S * m),
            ...
            var F = f.points[0],
              ...
              T = P.normalImpulse,
              k =
                (A.x - D * F.rB.y - B.x + v * F.rA.y) * V +
                (A.y + D * F.rB.x - B.y - v * F.rA.x) * I,
              N =
                (A.x - D * P.rB.y - B.x + v * P.rA.y) * V +
                (A.y + D * P.rB.x - B.y - v * P.rA.x) * I,
              z = k - F.velocityBias,
              E = N - P.velocityBias;
            (z -= (o = f.K).col1.x * R + o.col2.x * T),
              (E -= o.col1.y * R + o.col2.y * T);
            for (;;) {
              var j = -((o = f.normalMass).col1.x * z + o.col2.x * E),
                U = -(o.col1.y * z + o.col2.y * E);
              if (j >= 0 && U >= 0) {
                (_ = (c = j - R) * V),
                  (p = c * I),
                  (y = (h = U - T) * V),
                  ...
                  (B.y -= S * (p + u)),
                  (v -=
                    w * (F.rA.x * p - F.rA.y * _ + P.rA.x * u - P.rA.y * y)),
                  (A.x += g * (_ + y)),
                  (A.y += g * (p + u)),
                  (D +=
                    M * (F.rB.x * p - F.rB.y * _ + P.rB.x * u - P.rB.y * y)),
                  (F.normalImpulse = j),
                  (P.normalImpulse = U);
                break;
              }
          ...
          (d.m_angularVelocity = v), (b.m_angularVelocity = D);
        }
      }),
        ...
        switch (t.type) {
          case g.e_circles:
            ...
            (this.m_points[0].x = 0.5 * (l + c)),
              (this.m_points[0].y = 0.5 * (m + h)),
              (this.m_separations[0] =
                _ * this.m_normal.x + p * this.m_normal.y - t.radius);
            break;
          case g.e_faceA:
            for (
              o = t.bodyA.m_xf.R,
    ...
    Box2D.inherit(n, Box2D.Dynamics.Controllers.b2Controller),
        ...
        if (this.invSqr)
          for (o = this.m_bodyList; o; o = o.nextBody)
            for (
              ...
              (h =
                (m = (l = (a = r.body).GetWorldCenter()).x - n.x) * m +
                (c = l.y - n.y) * c) < Number.MIN_VALUE ||
                ((_ = new i(m, c)).Multiply(
                  (this.G / h / Math.sqrt(h)) * s * a.GetMass()
                ),
                e.IsAwake() && e.ApplyForce(_, n),
                _.Multiply(-1),
                a.IsAwake() && a.ApplyForce(_, l));
        else
          for (o = this.m_bodyList; o; o = o.nextBody)
            for (
              n = (e = o.body).GetWorldCenter(),
              ...
              (h =
                (m = (l = (a = r.body).GetWorldCenter()).x - n.x) * m +
                (c = l.y - n.y) * c) < Number.MIN_VALUE ||
                ((_ = new i(m, c)).Multiply((this.G / h) * s * a.GetMass()),
                e.IsAwake() && e.ApplyForce(_, n),
                _.Multiply(-1),
                a.IsAwake() && a.ApplyForce(_, l));
      }),
      ...
      (c.prototype.SetAxisAligned = function (t, o) {
        void 0 === t && (t = 0),
          ...
          (this.T.col2.x = 0),
          (this.T.col2.y = -o),
          (this.maxTimestep = t > 0 || o > 0 ? 1 / Math.max(t, o) : 0);
      }),
    ...
    Box2D.inherit(r, Box2D.Dynamics.Joints.b2Joint),
      ...
      (l.prototype.InitVelocityConstraints = function (t) {
        ...
        if (
          ...
          (n.m_linearVelocity.x -= c * u.x),
            ...
            (n.m_angularVelocity -=
              _ * (r * u.y - a * u.x + this.m_angularImpulse)),
            (s.m_linearVelocity.x += h * u.x),
            (s.m_linearVelocity.y += h * u.y),
            (s.m_angularVelocity +=
      ...
      (c.prototype.SolvePositionConstraints = function (o) {
        ...
        var r = this.m_constant - (n + this.m_ratio * s),
          a = -this.m_mass * r;
        return (
          (i.m_sweep.c.x += i.m_invMass * a * this.m_J.linearA.x),
          (i.m_sweep.c.y += i.m_invMass * a * this.m_J.linearA.y),
          (i.m_sweep.a += i.m_invI * a * this.m_J.angularA),
          (e.m_sweep.c.x += e.m_invMass * a * this.m_J.linearB.x),
          (e.m_sweep.c.y += e.m_invMass * a * this.m_J.linearB.y),
          (e.m_sweep.a += e.m_invI * a * this.m_J.angularB),
      ...
      (x.prototype.GetJointSpeed = function () {
        ...
        var l = o.m_sweep.c.x + e,
          ...
          c = i.m_sweep.c.x + r - l,
          h = i.m_sweep.c.y + a - m,
          _ = o.GetWorldVector(this.m_localXAxis1),
          p = o.m_linearVelocity,
          y = i.m_linearVelocity,
          u = o.m_angularVelocity,
      ...
      (x.prototype.InitVelocityConstraints = function (o) {
        ...
        (this.m_invMassA = n.m_invMass),
          ...
          (this.m_a1 = (_ + l) * this.m_axis.y - (y + m) * this.m_axis.x),
          ...
          (this.m_s1 = (_ + l) * this.m_perp.y - (y + m) * this.m_perp.x),
      ...
      (x.prototype.SolveVelocityConstraints = function (t) {
        ...
        if (this.m_enableMotor && this.m_limitState != p.e_equalLimits) {
          ...
          (this.m_motorImpulse = e.Clamp(this.m_motorImpulse + u, -f, f)),
            (m = (u = this.m_motorImpulse - x) * this.m_axis.x),
            (c = u * this.m_axis.y),
            (h = u * this.m_a1),
            (_ = u * this.m_a2),
        ...
        if (this.m_enableLimit && this.m_limitState != p.e_inactiveLimit) {
          ...
          (C = 0 != this.m_K.col1.x ? B / this.m_K.col1.x + v.x : v.x),
            ...
            (h = D.x * this.m_s1 + D.y * this.m_a1),
            (_ = D.x * this.m_s2 + D.y * this.m_a2),
            (s.x -= this.m_invMassA * m),
            (s.y -= this.m_invMassA * c),
            (r -= this.m_invIA * h),
            (a.x += this.m_invMassB * m),
      ...
      (x.prototype.SolvePositionConstraints = function (i) {
        ...
        (_ = s.col1.x * B + s.col2.x * C),
          (C = s.col1.y * B + s.col2.y * C),
          (B = _),
          (s = D);
        var A = this.m_localAnchor2.x - this.m_localCenterB.x,
          S = this.m_localAnchor2.y - this.m_localCenterB.y;
        (_ = s.col1.x * A + s.col2.x * S),
          (S = s.col1.y * A + s.col2.y * S),
          (A = _);
        var w = c.x + A - l.x - B,
          g = c.y + S - l.y - C;
        if (this.m_enableLimit) {
          (this.m_axis = e.MulMV(v, this.m_localXAxis1)),
            (this.m_a1 = (w + B) * this.m_axis.y - (g + C) * this.m_axis.x),
            (this.m_a2 = A * this.m_axis.y - S * this.m_axis.x);
          var M = this.m_axis.x * w + this.m_axis.y * g;
          e.Abs(this.m_upperTranslation - this.m_lowerTranslation) <
          2 * t.b2_linearSlop
            ? ((b = e.Clamp(
                M,
            ...
            ? ((b = e.Clamp(
                M - this.m_lowerTranslation + t.b2_linearSlop,
                -t.b2_maxLinearCorrection,
                0
              )),
              (f = this.m_lowerTranslation - M),
              (d = !0))
            : M >= this.m_upperTranslation &&
              ((b = e.Clamp(
                M - this.m_upperTranslation + t.b2_linearSlop,
                0,
                t.b2_maxLinearCorrection
              )),
              (f = M - this.m_upperTranslation),
              (d = !0));
        }
        (this.m_perp = e.MulMV(v, this.m_localYAxis1)),
          (this.m_s1 = (w + B) * this.m_perp.y - (g + C) * this.m_perp.x),
          (this.m_s2 = A * this.m_perp.y - S * this.m_perp.x);
        var V = new n(),
          I = this.m_perp.x * w + this.m_perp.y * g;
        if (((f = e.Max(f, e.Abs(I))), 0, d))
          (p = this.m_invMassA),
            (y = this.m_invMassB),
            (u = this.m_invIA),
            (x = this.m_invIB),
            ...
            this.m_K.Solve(V, -I, -b);
        else {
          (p = this.m_invMassA),
            (y = this.m_invMassB),
            (u = this.m_invIA),
            (x = this.m_invIB);
          var G = p + y + u * this.m_s1 * this.m_s1 + x * this.m_s2 * this.m_s2,
            L = 0;
          (L = 0 != G ? -I / G : 0), (V.x = L), (V.y = 0);
        }
        var J = V.x * this.m_perp.x + V.y * this.m_axis.x,
          F = V.x * this.m_perp.y + V.y * this.m_axis.y,
          P = V.x * this.m_s1 + V.y * this.m_a1,
          R = V.x * this.m_s2 + V.y * this.m_a2;
        return (
          (l.x -= this.m_invMassA * J),
          (l.y -= this.m_invMassA * F),
          (m -= this.m_invIA * P),
          (c.x += this.m_invMassB * J),
          (c.y += this.m_invMassB * F),
          (h += this.m_invIB * R),
          (r.m_sweep.a = m),
          (a.m_sweep.a = h),
          r.SynchronizeTransform(),
          a.SynchronizeTransform(),
          f <= t.b2_linearSlop && 0 <= t.b2_angularSlop
        );
      }),
      ...
      (d.prototype.InitVelocityConstraints = function (t) {
        ...
        (this.K1.col1.x = c),
          ...
          (o.m_angularVelocity +=
            h * (a * this.m_impulse.y - l * this.m_impulse.x));
      }),
      ...
      (v.prototype.SolveVelocityConstraints = function (t) {
        ...
        if (this.m_enableMotor && this.m_limitState != p.e_equalLimits) {
          ...
          (this.m_motorImpulse = e.Clamp(this.m_motorImpulse + x, -d, d)),
            (c = (x = this.m_motorImpulse - f) * this.m_axis.x),
            (h = x * this.m_axis.y),
            (_ = x * this.m_a1),
            (y = x * this.m_a2),
      ...
      (v.prototype.SolvePositionConstraints = function (i) {
        ...
        return (
          ...
          (c -= this.m_invIA * z),
          (h.x += this.m_invMassB * k),
          (h.y += this.m_invMassB * N),
          (_ += this.m_invIB * E),
          (a.m_sweep.a = c),
          (l.m_sweep.a = _),
          a.SynchronizeTransform(),
      ...
      (B.prototype.InitVelocityConstraints = function (o) {
        ...
        b > t.b2_linearSlop ? this.m_u1.Multiply(1 / b) : this.m_u1.SetZero(),
          ...
          this.m_constant - b - this.m_ratio * v > 0
        ...
        if (
          ((this.m_limitMass1 = e.m_invMass + e.m_invI * D * D),
          (this.m_limitMass2 = n.m_invMass + n.m_invI * B * B),
          (this.m_pulleyMass =
            this.m_limitMass1 +
          ...
          (e.m_linearVelocity.x += e.m_invMass * C),
            (e.m_linearVelocity.y += e.m_invMass * A),
            (e.m_angularVelocity += e.m_invI * (s * A - r * C)),
            (n.m_linearVelocity.x += n.m_invMass * S),
            (n.m_linearVelocity.y += n.m_invMass * w),
            (n.m_angularVelocity += n.m_invI * (l * w - m * S));
        } else
          (this.m_impulse = 0),
            (this.m_limitImpulse1 = 0),
            (this.m_limitImpulse2 = 0);
      ...
      (B.prototype.SolveVelocityConstraints = function (t) {
        ...
        this.m_state == p.e_atUpperLimit &&
          ...
          (b =
            -(this.m_u1.x * c + this.m_u1.y * h) -
            this.m_ratio * (this.m_u2.x * _ + this.m_u2.y * y)),
          (v = this.m_pulleyMass * -b),
          (D = this.m_impulse),
          (this.m_impulse = e.Max(0, this.m_impulse + v)),
          (u = -(v = this.m_impulse - D) * this.m_u1.x),
          (x = -v * this.m_u1.y),
      ...
      (B.prototype.SolvePositionConstraints = function (o) {
        ...
        return (
          this.m_state == p.e_atUpperLimit &&
            ...
            (c = C),
            (i = s.m_xf.R),
            (_ = this.m_localAnchor2.x - s.m_sweep.localCenter.x),
            (y = this.m_localAnchor2.y - s.m_sweep.localCenter.y),
            (C = i.col1.x * _ + i.col2.x * y),
            (y = i.col1.y * _ + i.col2.y * y),
            (_ = C),
            (u = n.m_sweep.c.x + c),
            (x = n.m_sweep.c.y + h),
            (f = s.m_sweep.c.x + _),
          ...
          this.m_limitState1 == p.e_atUpperLimit &&
            ...
            (x = n.m_sweep.c.y + h),
            this.m_u1.Set(u - r, x - a),
            (b = this.m_u1.Length()) > t.b2_linearSlop
              ? ((this.m_u1.x *= 1 / b), (this.m_u1.y *= 1 / b))
              : this.m_u1.SetZero(),
            (D = this.m_maxLength1 - b),
            (A = e.Max(A, -D)),
            (D = e.Clamp(D + t.b2_linearSlop, -t.b2_maxLinearCorrection, 0)),
            (u = -(B = -this.m_limitMass1 * D) * this.m_u1.x),
            (x = -B * this.m_u1.y),
            (n.m_sweep.c.x += n.m_invMass * u),
            (n.m_sweep.c.y += n.m_invMass * x),
            (n.m_sweep.a += n.m_invI * (c * x - h * u)),
          ...
          this.m_limitState2 == p.e_atUpperLimit &&
            ...
            (d = s.m_sweep.c.y + y),
            this.m_u2.Set(f - l, d - m),
            (v = this.m_u2.Length()) > t.b2_linearSlop
              ? ((this.m_u2.x *= 1 / v), (this.m_u2.y *= 1 / v))
              : this.m_u2.SetZero(),
            (D = this.m_maxLength2 - v),
            (A = e.Max(A, -D)),
            (D = e.Clamp(D + t.b2_linearSlop, -t.b2_maxLinearCorrection, 0)),
            (f = -(B = -this.m_limitMass2 * D) * this.m_u2.x),
            (d = -B * this.m_u2.y),
            (s.m_sweep.c.x += s.m_invMass * f),
            (s.m_sweep.c.y += s.m_invMass * d),
            (s.m_sweep.a += s.m_invI * (_ * d - y * f)),
      ...
      (C.prototype.Initialize = function (t, o, i, e, n, s, r) {
        ...
        (this.maxLengthA = h - this.ratio * B.b2_minPulleyLength),
          (this.maxLengthB = (h - B.b2_minPulleyLength) / this.ratio);
      }),
      ...
      (A.prototype.InitVelocityConstraints = function (o) {
        ...
        var h = n.m_invMass,
          ...
          u = s.m_invI;
        if (
          ((this.m_mass.col1.x = h + _ + l * l * y + c * c * u),
          (this.m_mass.col2.x = -l * a * y - c * m * u),
          (this.m_mass.col3.x = -l * y - c * u),
          (this.m_mass.col1.y = this.m_mass.col2.x),
          (this.m_mass.col2.y = h + _ + a * a * y + m * m * u),
        ...
        if (o.warmStarting) {
          ...
          (n.m_linearVelocity.x -= h * f),
            (n.m_linearVelocity.y -= h * d),
            (n.m_angularVelocity -=
              y * (a * d - l * f + this.m_motorImpulse + this.m_impulse.z)),
            (s.m_linearVelocity.x += _ * f),
            (s.m_linearVelocity.y += _ * d),
            (s.m_angularVelocity +=
      ...
      (A.prototype.SolveVelocityConstraints = function (t) {
        ...
        if (this.m_enableMotor && this.m_limitState != p.e_equalLimits) {
          ...
          (this.m_motorImpulse = e.Clamp(this.m_motorImpulse + v, -B, B)),
            (h -= f * (v = this.m_motorImpulse - D)),
            (y += d * v);
        }
        if (this.m_enableLimit && this.m_limitState != p.e_inactiveLimit) {
          (o = i.m_xf.R),
            (r = this.m_localAnchor1.x - i.m_sweep.localCenter.x),
            (a = this.m_localAnchor1.y - i.m_sweep.localCenter.y),
            (s = o.col1.x * r + o.col2.x * a),
            (a = o.col1.y * r + o.col2.y * a),
            (r = s),
            (o = n.m_xf.R),
            (l = this.m_localAnchor2.x - n.m_sweep.localCenter.x),
            (m = this.m_localAnchor2.y - n.m_sweep.localCenter.y),
            (s = o.col1.x * l + o.col2.x * m),
            (m = o.col1.y * l + o.col2.y * m),
            (l = s);
          var C = _.x + -y * m - c.x - -h * a,
            A = _.y + y * l - c.y - h * r,
            S = y - h;
          this.m_mass.Solve33(this.impulse3, -C, -A, -S),
            this.m_limitState == p.e_equalLimits
              ? this.m_impulse.Add(this.impulse3)
              : this.m_limitState == p.e_atLowerLimit
              ? this.m_impulse.z + this.impulse3.z < 0 &&
                (this.m_mass.Solve22(this.reduced, -C, -A),
              ...
              : this.m_limitState == p.e_atUpperLimit &&
                ...
                (this.m_impulse.y += this.reduced.y),
                (this.m_impulse.z = 0)),
            (c.x -= u * this.impulse3.x),
            (c.y -= u * this.impulse3.y),
            (h -=
              f *
              (r * this.impulse3.y - a * this.impulse3.x + this.impulse3.z)),
            (_.x += x * this.impulse3.x),
            (_.y += x * this.impulse3.y),
            (y +=
              d *
              (l * this.impulse3.y - m * this.impulse3.x + this.impulse3.z));
        } else {
          (o = i.m_xf.R),
            (r = this.m_localAnchor1.x - i.m_sweep.localCenter.x),
            (a = this.m_localAnchor1.y - i.m_sweep.localCenter.y),
            ...
            (m = o.col1.y * l + o.col2.y * m),
            (l = s);
          var w = _.x + -y * m - c.x - -h * a,
            g = _.y + y * l - c.y - h * r;
          this.m_mass.Solve22(this.impulse2, -w, -g),
            (this.m_impulse.x += this.impulse2.x),
            (this.m_impulse.y += this.impulse2.y),
            (c.x -= u * this.impulse2.x),
            (c.y -= u * this.impulse2.y),
            (h -= f * (r * this.impulse2.y - a * this.impulse2.x)),
            (_.x += x * this.impulse2.x),
            (_.y += x * this.impulse2.y),
            (y += d * (l * this.impulse2.y - m * this.impulse2.x));
        }
        i.m_linearVelocity.SetV(c),
          (i.m_angularVelocity = h),
          n.m_linearVelocity.SetV(_),
          (n.m_angularVelocity = y);
      }),
      (A.prototype.SolvePositionConstraints = function (o) {
        ...
        if (this.m_enableLimit && this.m_limitState != p.e_inactiveLimit) {
          ...
          this.m_limitState == p.e_equalLimits
            ...
            ? ((a = -(n = _ - this.m_lowerAngle)),
              ...
              (y = -this.m_motorMass * n))
            : this.m_limitState == p.e_atUpperLimit &&
              ((a = n = _ - this.m_upperAngle),
              (n = e.Clamp(n - t.b2_angularSlop, 0, t.b2_maxAngularCorrection)),
              (y = -this.m_motorMass * n)),
        ...
        if (D > M * M) {
          var V = 1 / (C + S);
          (c = V * -b), (h = V * -v);
          (s.m_sweep.c.x -= 0.5 * C * c),
            (s.m_sweep.c.y -= 0.5 * C * h),
            (r.m_sweep.c.x += 0.5 * S * c),
            (r.m_sweep.c.y += 0.5 * S * h),
        ...
        return (
          ...
          (s.m_sweep.a -= s.m_invI * (u * h - x * c)),
          (r.m_sweep.c.x += r.m_invMass * c),
          (r.m_sweep.c.y += r.m_invMass * h),
          (r.m_sweep.a += r.m_invI * (f * h - d * c)),
          s.SynchronizeTransform(),
          r.SynchronizeTransform(),
      ...
      (w.prototype.InitVelocityConstraints = function (t) {
        ...
        var m = e.m_invMass,
          ...
          h = e.m_invI,
          _ = n.m_invI;
        (this.m_mass.col1.x = m + c + r * r * h + l * l * _),
          (this.m_mass.col2.x = -r * s * h - l * a * _),
          (this.m_mass.col3.x = -r * h - l * _),
          (this.m_mass.col1.y = this.m_mass.col2.x),
          (this.m_mass.col2.y = m + c + s * s * h + a * a * _),
          (this.m_mass.col3.y = s * h + a * _),
          (this.m_mass.col1.z = this.m_mass.col3.x),
          (this.m_mass.col2.z = this.m_mass.col3.y),
          (this.m_mass.col3.z = h + _),
          t.warmStarting
            ? ((this.m_impulse.x *= t.dtRatio),
              (this.m_impulse.y *= t.dtRatio),
      ...
      (w.prototype.SolvePositionConstraints = function (o) {
        ...
        var _ = r.m_invMass,
          ...
          D = e.Abs(d);
        v > b && ((y *= 1), (u *= 1)),
          (this.m_mass.col1.x = _ + p + m * m * y + h * h * u),
          (this.m_mass.col2.x = -m * l * y - h * c * u),
          (this.m_mass.col3.x = -m * y - h * u),
          (this.m_mass.col1.y = this.m_mass.col2.x),
          (this.m_mass.col2.y = _ + p + l * l * y + c * c * u),
